...
namespace ServiceLayer
{
    public class CulinaryChannelService : ICulinaryChannelService
    {
        ...
        public CulinaryChannelService(IReadOnlyGenericRepository<CulinaryChannel> culinaryChannelReadOnlyRepository,
        ...
        {
            return this.culinaryChannelReadOnlyRepository.GetItemWithInclude(x => x.Id == id, x => x.Episodes);
        }
    }
}
