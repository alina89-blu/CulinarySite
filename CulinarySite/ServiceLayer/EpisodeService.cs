...
namespace ServiceLayer
{
    public class EpisodeService : IEpisodeService
    {
        ...
        public EpisodeService(IReadOnlyGenericRepository<Episode> episodeReadOnlyRepository,
        ...
        {
            return this.episodeReadOnlyRepository.GetItemWithInclude(x => x.Id == id, x => x.CulinaryChannel, x => x.Image, x => x.Tags);
        }
        public IEnumerable<Episode> GetEpisodeListWithInclude()
        {
            return this.episodeReadOnlyRepository.GetItemListWithInclude(x => x.CulinaryChannel, x => x.Image, x => x.Tags);
        }
