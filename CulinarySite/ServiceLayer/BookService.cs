...
namespace ServiceLayer
{
    public class BookService : IBookService
    {
        ...
        public BookService(IReadOnlyGenericRepository<Book> bookReadOnlyRepository,
        ...
        {
            return this.bookReadOnlyRepository.GetItemListWithInclude(x => x.Recipes, x => x.Images, x => x.Author);
        }
        public Book GetBookWithInclude(int id)
        {
            return this.bookReadOnlyRepository.GetItemWithInclude(x => x.Id == id, x => x.Recipes, x => x.Images, x => x.Author);
        }
    }
}
