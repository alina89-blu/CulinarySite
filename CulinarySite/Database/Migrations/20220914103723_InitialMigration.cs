    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganicMatters", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Telephones_Restaurants_RestaurantId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentRestaurant", x => new { x.CommentsId, x.RestaurantsId });
                    table.ForeignKey(
                        name: "FK_CommentRestaurant_Comments_CommentsId",
                        column: x => x.CommentsId,
                        principalTable: "Comments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommentRestaurant_Restaurants_RestaurantsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CookingStages_Recipes_RecipeId",
                        column: x => x.RecipeId,
            ...
            migrationBuilder.CreateTable(
                name: "OrganicMatterRecipe",
                columns: table => new
                {
                    OrganicMattersId = table.Column<int>(type: "int", nullable: false),
                    RecipesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganicMatterRecipe", x => new { x.OrganicMattersId, x.RecipesId });
                    table.ForeignKey(
                        name: "FK_OrganicMatterRecipe_OrganicMatters_OrganicMattersId",
                        column: x => x.OrganicMattersId,
                        principalTable: "OrganicMatters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrganicMatterRecipe_Recipes_RecipesId",
                        column: x => x.RecipesId,
                        principalTable: "Recipes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentRestaurant_RestaurantsId",
                table: "CommentRestaurant",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CookingStages_RecipeId",
                table: "CookingStages",
                column: "RecipeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrganicMatterRecipe_RecipesId",
                table: "OrganicMatterRecipe",
                column: "RecipesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Telephones_RestaurantId",
                table: "Telephones",
                column: "RestaurantId");
        }
